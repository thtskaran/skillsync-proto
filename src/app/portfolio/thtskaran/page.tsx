...
// --- Inline logo components (lightweight placeholders) ---
...
// --- Demo data (no network calls; replace with live stats when you wire APIs) ---
const skills = [
...
const extracurriculars = [
  {
    title: "HexaFalls — Winner",
    desc: "Led a 3-person team; built a resilient backend and won the hackathon.",
    icon: Trophy,
    date: "2024",
  },
  {
    title: "Agile Kolkata — Conference Presenter",
    desc: "Spoke on rapid iteration for student-led OSS projects.",
    icon: Award,
    date: "2024",
  },
];
...
const experiences = [
  {
    ...
    desc: "Built full‑stack apps using the MERN stack, delivering end‑to‑end web solutions for clients.",
  },
  {
    title: "Tech Lead",
    org: "DevsDose (Self‑employed)",
    range: "Apr 2024 — Present",
    desc: "Led project execution spanning full‑stack web apps, automation tools, and AWS cloud architecture.",
  },
];
...
const moocs = [
  {
    provider: "Coursera",
    title: "Google IT Automation with Python (WIP)",
  ...
  {
    provider: "Udemy",
    title: "Modern AI/LLMs: Prompt Engineering & Applications",
...
const platforms = [
  {
    label: "GitHub",
    username: "thtskaran",
    url: "https://github.com/thtskaran",
    icon: Github,
  },
  {
    label: "LeetCode",
    username: "thtskaran",
    url: "https://leetcode.com/thtskaran",
    icon: FileCode2,
  },
];

// Academic metrics (demo values)
const sgpa = 8.6; // out of 10
const attendance = 92; // in percent

// --- Lightweight test helpers (exported for external test runners) ---
...
export const __testcases__ = [
  { name: "sgpa in range", actual: validateMetrics({ sgpa: 8.6, attendance: 92 }).sgpaValid, expected: true },
  ...
  // Additional tests for boundary and invalid values
...
export default function SkillSyncProfile() {
  const [rank] = React.useState(3); // current visible rank (audience view only)
  const totalStudents = 120; // cohort size

  // Ensure chart renders only on client to prevent RSC/SSR issues
    ...
    <div className="min-h-screen w-full bg-neutral-50">
      ...
      <header className="sticky top-0 z-20 backdrop-blur supports-[backdrop-filter]:bg-white/60 bg-white/90 border-b">
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-3">
          <div className="size-8 rounded-xl bg-gradient-to-br from-indigo-500 via-violet-500 to-fuchsia-500" />
      ...
      <main className="mx-auto max-w-6xl px-4 py-6">
          ...
          <CardContent className="p-6 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] items-center gap-6">
              <Avatar className="size-20 md:size-24 ring-4 ring-white shadow">
                <AvatarImage src="" alt="Karan Prasad" />
                <AvatarFallback className="text-lg">KP</AvatarFallback>
              </Avatar>

              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Karan Prasad</h2>
                  <Badge className="rounded-full">Batch 2024 — IT</Badge>
                </div>
                <div className="mt-2 flex items-center gap-3 flex-wrap text-neutral-600">
                  ...
                  <span className="inline-flex items-center gap-1"><MapPin className="size-4"/> Kolkata, IN</span>
                </div>
                <p className="mt-3 text-neutral-700 max-w-2xl">
                  Open‑source developer focused on security automation, backend systems, and high‑performance tooling. Exploring Rust, TypeScript, and scalable cloud patterns.
                </p>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  <Badge variant="outline" className="rounded-full font-mono">@thtskaran</Badge>
                </div>
              </div>

              {/* Rank badge (display-only) */}
              <div className="flex flex-col items-end gap-3">
                ...
                <div className="flex items-center gap-2 text-xs text-neutral-500">
                  <Users className="size-3.5" /> IT 2024 Cohort
                </div>
              </div>
            </div>
          </CardContent>
        ...
        {/* Combined Overview: Skills + Courses + Extracurricular */}
        ...
        <section className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="rounded-2xl">
              <CardContent className="p-6">
                <div className="flex items-center gap-2 mb-4"><BookOpen className="size-5"/><span className="font-semibold">MOOCs — Python & AI</span></div>
                <div className="space-y-4">
                  {moocs.map((m, i) => (
                    <div key={i} className="flex items-start justify-between gap-3">
                      <div className="flex items-start gap-2">
